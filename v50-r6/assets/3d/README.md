...
Rebuild these committed outputs with Blender 4.5.x LTS (4.5.5 preferred) and the workspace
optimizer:
...
Blender 4.5.x LTS (4.5.5 preferred) creates bounded normalized smart-UV islands across each batched
