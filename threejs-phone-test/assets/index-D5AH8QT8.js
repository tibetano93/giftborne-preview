...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bs(e,t,n){let r=new Float32Array(os),i=new W(0,1,0);return new _a({name:`SphericalGaussianBlur`,defines:{n:os,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Cs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xs(){return new _a({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Cs(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},pd=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},md=new vo(-1,1,1,-1,0,1),hd=new class extends Or{constructor(){super(),this.setAttribute(`position`,new gr([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new gr([0,2,0,0,2,0],2))}},gd=class{constructor(e){this._mesh=new ei(hd,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,md)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},_d=class extends pd{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof _a?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=ma.clone(e.uniforms),this.material=new _a({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new gd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},vd=class extends pd{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},yd=class extends pd{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},bd=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new U);this._width=n.width,this._height=n.height,t=new Yt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:_}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new _d(fd),this.copyPass.material.blending=0,this.timer=new Oo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}vd!==void 0&&(r instanceof vd?n=!0:r instanceof yd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new U);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},xd=class extends pd{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Sd={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Y(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Cd.BlurDirectionX=new U(1,0),Cd.BlurDirectionY=new U(0,1);var wd={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Td=class extends pd{constructor(){super(),this.isOutputPass=!0,this.uniforms=ma.clone(wd.uniforms),this.material=new va({name:wd.name,uniforms:this.uniforms,vertexShader:wd.vertexShader,fragmentShader:wd.fragmentShader}),this._fsQuad=new gd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},K.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Ed=!1,Dd=!1;function Od(){let e=window.Telegram?.WebApp;return{telegramBridgeDetected:!!e?.initData,platform:e?.initData?e.platform:null,version:e?.initData?e.version:null,physicalDeviceVerified:!1}}function kd(){let e=window.Telegram?.WebApp;if(e?.initData)for(let t of[`top`,`right`,`bottom`,`left`]){let n=Math.max(0,Number(e.safeAreaInset?.[t])||0,Number(e.contentSafeAreaInset?.[t])||0);document.documentElement.style.setProperty(`--host-`+t,Math.min(160,n)+`px`)}}function Ad(){let e=window.Telegram?.WebApp;if(Ed&&e?.initData)try{kd(),Dd||=(e.onEvent?.(`safeAreaChanged`,kd),e.onEvent?.(`contentSafeAreaChanged`,kd),!0),e.ready?.(),e.expand?.()}catch{}}function jd(){Ed=!0,Ad()}window.addEventListener(`telegram-sdk-loaded`,Ad);function Md(e){let t=document.createElement(`button`);t.id=`fps-test`,t.textContent=`Тест FPS`,document.querySelector(`header`).append(t);let n=document.createElement(`dialog`);n.id=`perf-panel`,n.innerHTML=`<h2>Three.js · тест на телефоне</h2><p>Оба режима: движение, удар и ожидание. Держите телефон горизонтально, не сворачивайте Telegram. 1 минута — быстрая проверка; 10 минут — длительная нагрузка.</p><p>Это тест сцены, не всей игры. Данные остаются на устройстве.</p><button data-duration="60">1 минута</button> <button data-duration="600">10 минут</button> <button id="perf-close">Закрыть</button><pre id="perf-result"></pre><button id="perf-save" hidden>Сохранить JSON</button> <button id="perf-copy" hidden>Копировать результат</button><textarea id="perf-json" aria-label="Результат JSON для копирования" readonly hidden></textarea>`,document.body.append(n);let r=document.createElement(`div`);r.id=`perf-progress`,r.hidden=!0,r.innerHTML=`<span></span> <button>Отмена</button>`,document.body.append(r);let i=!1,a=0,o=null,s=`baseline`,c=0,l=e=>{document.querySelectorAll(`aside button,footer button,#fps-test`).forEach(t=>t.disabled=e),document.body.classList.toggle(`benchmark-running`,e)},u=e=>{let t=[...e].sort((e,t)=>e-t),n=e.reduce((e,t)=>e+t,0);return{frames:e.length,measuredMs:n,averageFps:n?1e3*e.length/n:null,frameTimeMs:{p50:t[Math.floor(t.length*.5)]??null,p95:t[Math.floor(t.length*.95)]??null,p99:t[Math.floor(t.length*.99)]??null,max:t.at(-1)??null},framesOver33_34ms:e.filter(e=>e>33.34).length,framesOver50ms:e.filter(e=>e>50).length}};function d(t){i&&(i=!1,cancelAnimationFrame(a),l(!1),r.hidden=!0,e.freeze(),e.setMode(s),o.status=t?`interrupted`:`complete`,o.interruption=t,o.finishedAt=new Date().toISOString(),o.phases=o.phases.map(e=>{let{samples:t,...n}=e;return{...n,...u(t.map(e=>e.ms)),early:u(t.filter(e=>e.t<35e3).map(e=>e.ms)),late:u(t.filter(e=>e.t>o.phaseDurationMs-3e4).map(e=>e.ms))}}),n.querySelector(`pre`).textContent=(t?`Прерван: `+t:`Тест завершён`)+`
`+o.phases.map(e=>`${e.mode===`baseline`?`Сопоставимый`:`Художественный`}: ${e.averageFps?.toFixed(1)??`—`} FPS\np95: ${e.frameTimeMs.p95?.toFixed(1)??`—`} мс; кадров >50 мс: ${e.framesOver50ms}`).join(`

`)+`

Это интервалы кадров, не время GPU. Нагрев оценивается вручную.`,n.querySelector(`#perf-save`).hidden=!1,n.querySelector(`#perf-copy`).hidden=!1,n.querySelector(`textarea`).value=JSON.stringify(o,null,2),n.showModal())}function f(t){if(i||![60,600].includes(t))return;s=e.metrics().mode,n.close(),n.querySelector(`textarea`).hidden=!0,i=!0,l(!0),r.hidden=!1,c=0;let u=t*500;o={schemaVersion:1,engine:`Three.js`,engineVersion:`0.185.1`,build:`three-phone-v1`,sourceCommit:`eacaaceafb8705a5489853387de88475f214a9c4`,test:`visual-route-attack-idle-v1`,status:`running`,startedAt:new Date().toISOString(),requestedSeconds:t,phaseDurationMs:u,warmupPerPhaseMs:5e3,earlyLateWindowsOverlap:u<65e3,browser:navigator.userAgent,...Od(),viewport:[innerWidth,innerHeight],devicePixelRatio,hardwareConcurrency:navigator.hardwareConcurrency,gpuTimeMs:null,temperatureC:null,runtimeNote:`No launch data or identifiers collected. Bridge and browser facts do not prove a physical phone.`,phases:[]};let f=-1,p=0,m=0,h=-1;function g(t){if(!i)return;if(f<0||t-p>=u){if(f===1){d(null);return}f++,p=t,m=t,h=-1,e.setMode(f?`polished`:`baseline`),o.phases.push({mode:f?`polished`:`baseline`,samples:[],configuration:e.metrics()})}let n=t-p,s=n%2e4,l=s<12e3?0:s<16e3?1:2;h!==l&&(h=l,h===0?e.startDemo():e.play(h===1?`Attack`:`Idle`)),n>=5e3&&m-p>=5e3&&o.phases[f].samples.push({t:n,ms:t-m}),m=t,t-c>500&&(c=t,r.querySelector(`span`).textContent=`${f?`Художественный`:`Сопоставимый`} · осталось ${Math.ceil((u-n)/1e3)} с${n<5e3?` · прогрев`:``}`),a=requestAnimationFrame(g)}a=requestAnimationFrame(g)}t.onclick=()=>n.showModal(),n.querySelector(`#perf-close`).onclick=()=>n.close(),n.querySelectorAll(`[data-duration]`).forEach(e=>e.onclick=()=>f(Number(e.dataset.duration))),r.querySelector(`button`).onclick=()=>d(`Отменён пользователем`),document.addEventListener(`visibilitychange`,()=>{document.hidden&&d(`Приложение свёрнуто`)}),window.addEventListener(`resize`,()=>d(`Изменился размер окна`)),document.querySelector(`canvas`).addEventListener(`webglcontextlost`,()=>d(`Потерян WebGL context`)),n.querySelector(`#perf-save`).onclick=()=>{let e=URL.createObjectURL(new Blob([JSON.stringify(o,null,2)],{type:`application/json`})),t=document.createElement(`a`);t.href=e,t.download=`threejs-phone-test.json`,t.click(),setTimeout(()=>URL.revokeObjectURL(e),3e3)},n.querySelector(`#perf-copy`).onclick=async()=>{try{await navigator.clipboard.writeText(JSON.stringify(o,null,2)),n.querySelector(`#perf-copy`).textContent=`Скопировано`}catch{let e=n.querySelector(`textarea`);e.hidden=!1,e.focus(),e.select()}},window.deviceTest={get active(){return i},get report(){return o}},new URLSearchParams(location.search).get(`test`)===`1`&&n.showModal()}var Nd=`eacaaceafb8705a5489853387de88475f214a9c4`,Pd=performance.now(),Fd=new cu({canvas:document.querySelector(`#scene`),antialias:!0,alpha:!1,preserveDrawingBuffer:!0,powerPreference:`high-performance`});Fd.outputColorSpace=He,Fd.toneMapping=4,Fd.toneMappingExposure=1,Fd.shadowMap.type=1,Fd.info.autoReset=!1;var Id=new Pn;Id.background=new Y(`#b6d5e8`);var Ld=new vo(-6,6,6,-6,.1,100);Ld.position.set(10,8,12),Ld.lookAt(0,1,0);var Rd=new bo(new Y(1,.89,.74),3);Rd.position.set(4,8,3),Id.add(Rd),Rd.shadow.mapSize.set(1024,1024),Object.assign(Rd.shadow.camera,{left:-10,right:10,top:10,bottom:-10,near:.1,far:35}),Rd.shadow.bias=-5e-4,Rd.shadow.normalBias=.015;var zd=new eo(new Y(.66,.82,1),new Y(.23,.29,.32),.9);Id.add(zd);var Bd=new _o(new Y(.15,1,.87),8,7,2);Bd.position.set(0,3.8,-4),Id.add(Bd);var Vd=document.createElement(`canvas`);Vd.width=Vd.height=512;var Hd=Vd.getContext(`2d`);Hd.fillStyle=`#9babae`,Hd.fillRect(0,0,512,512);for(let e=0;e<8;e++)for(let t=0;t<8;t++){let n=153+(t*13+e*7)%14;Hd.fillStyle=`rgb(${n},${n+11},${n+13})`,Hd.fillRect(t*64+1,e*64+1,62,62)}var Ud=new ra(Vd);Ud.colorSpace=He,Ud.wrapS=Ud.wrapT=t,Ud.repeat.set(3,3);var Wd=new ei(new ca(18,16),new ya({map:Ud,roughness:.93,metalness:0}));Wd.name=`stone-platform-18x16`,Wd.rotation.x=-Math.PI/2,Wd.receiveShadow=!0,Id.add(Wd);var Gd=new bd(Fd);Gd.addPass(new xd(Id,Ld));var Kd=new Cd(new U(956,440),.12,.25,1.2);Gd.addPass(Kd),Gd.addPass(new Td);var qd=new fu().setMeshoptDecoder(dd),Jd=`baseline`,Yd=`Idle`,Xd=!0,Zd=!1,Qd=0,$d=!1,ef=null,tf,nf,rf,af=[],of=[],sf=[],cf=!1,lf=performance.now(),uf={Idle:`Aetherion_Idle`,Run:`Aetherion_Run`,Attack:`Aetherion_RelicSlash_A`},df=new Map;function ff(e){let t=[];return e.traverseVisible(e=>{e.isMesh&&t.push(e)}),t}function pf(e){e.updateMatrixWorld(!0);let t=new Yn;for(let n of ff(e))n.isSkinnedMesh?(n.skeleton.update(),n.computeBoundingBox(),t.union(n.boundingBox.clone().applyMatrix4(n.matrixWorld))):(n.geometry.computeBoundingBox(),t.union(n.geometry.boundingBox.clone().applyMatrix4(n.matrixWorld)));return t}async function mf(e,t,n,r,i){let a=await qd.loadAsync(`./assets/3d/`+e),o=new En;if(o.name=t,o.add(a.scene),Id.add(o),i){let e=a.scene.getObjectByName(i);if(!e)throw Error(`Missing variant `+i);a.scene.traverse(t=>{if(t.isMesh){let n=t,r=!1;for(;n;)n===e&&(r=!0),n=n.parent;t.visible=i===`GB_VARIANT_LYRA_STARWARDEN`?t.name.includes(`LYRA_STARWARDEN`):r}})}let s=ff(o),c=pf(o),l=c.max.y-c.min.y;if(!s.length||!Number.isFinite(l)||l<=0)throw Error(`Invalid actor `+t);let u=n/l;o.scale.setScalar(u),o.position.set(...r),o.position.y-=c.min.y*u,o.userData.groundY=o.position.y;for(let e of s)e.castShadow=!0,e.receiveShadow=!0,e.frustumCulled=!1;return af.push({file:e,id:t,variant:i??null,sourceBounds:{min:c.min.toArray(),max:c.max.toArray()},height:n,scale:u,position:r,meshCount:s.length,triangles:s.reduce((e,t)=>e+(t.geometry.index?.count??t.geometry.attributes.position.count)/3,0)}),{root:o,gltf:a,meshes:s}}function hf(){let e=Jd===`baseline`?1:1.5;Fd.setPixelRatio(e),Fd.setSize(innerWidth,innerHeight,!1),Gd.setPixelRatio(e),Gd.setSize(innerWidth,innerHeight);let t=innerWidth/innerHeight;Ld.left=-6*t,Ld.right=6*t,Ld.top=6,Ld.bottom=-6,Ld.updateProjectionMatrix()}function gf(e){if(![`baseline`,`polished`].includes(e))throw Error(`Unknown mode`);Jd=e;let t=Jd===`polished`;Fd.shadowMap.enabled=t,Rd.castShadow=t,Rd.intensity=t?3.4:3,zd.intensity=t?.8:.9,Bd.intensity=t?12:8,Fd.toneMappingExposure=t?1.08:1,Id.traverse(e=>{if(e.isMesh)for(let t of[e.material].flat())t.needsUpdate=!0}),hf();for(let e of[`baseline`,`polished`]){let t=document.querySelector(`#`+e);t.classList.toggle(`selected`,e===Jd),t.setAttribute(`aria-pressed`,String(e===Jd))}document.querySelector(`#settings`).textContent=t?`DPR 1.5 · PCF-тени 1024 · bloom 0.12. Свет 3.4 / 0.8 / 12 · ACES · экспозиция 1.08. Без SSAO / DOF.`:`DPR 1 · без теней, bloom, SSAO, DOF. Свет 3 / 0.9 / 8 · ACES · экспозиция 1.0. Исходные glTF-материалы.`}function _f(){document.querySelector(`#status`).textContent=`${Zd?`Маршрут 12 с`:Yd}${Xd?` · t = 0.5 с`:``} · WebGL 2`,document.querySelectorAll(`[data-clip]`).forEach(e=>e.classList.toggle(`selected`,e.dataset.clip===Yd))}function vf(e,t=!1){if(!df.has(e))throw Error(`Unknown animation `+e);Zd=!1,Xd=t,Yd=e,nf.stopAllAction(),rf=nf.clipAction(df.get(e)),rf.reset().play(),rf.time=t?.5:0,nf.update(0),rf.paused=t,_f()}function yf(e=!0){Zd=!1,Qd=0,tf.root.position.set(-1.6,tf.root.userData.groundY,0),tf.root.rotation.set(0,0,0),vf(`Idle`,e);for(let{mixer:e,action:t}of of)t.paused=!1,t.time=.5,e.update(0),t.paused=!0;Id.updateMatrixWorld(!0)}var bf=[new W(-1.6,0,0),new W(-4,0,1),new W(-4,0,3),new W(-1.6,0,0)];function xf(){yf(!1),vf(`Run`),Zd=!0,Qd=0,_f()}function Sf(){return{mode:Jd,clip:Yd,demo:Zd,frozen:Xd,position:tf.root.position.toArray(),meshCount:ff(Id).length,heroMeshCount:tf.meshes.length,lyraMeshNames:af.find(e=>e.id===`lyra`).meshCount,jointRotations:[`Head`,`hand_r`,`foot_l`].map(e=>({name:e,rotation:tf.gltf.scene.getObjectByName(e)?.quaternion.toArray()??null})),animationTime:rf.time}}function Cf(){cf=!1;let e=[...sf].sort((e,t)=>e-t),t=Fd.getContext(),n=t.getExtension(`WEBGL_debug_renderer_info`),r=Fd.getDrawingBufferSize(new U);return{engine:`Three.js`,version:`0.185.1`,revision:`185`,sourceCommit:Nd,mode:Jd,viewport:[innerWidth,innerHeight],drawingBuffer:r.toArray(),effectiveDPR:Fd.getPixelRatio(),webgl:2,assets:af,triangles:Fd.info.render.triangles,drawCalls:Fd.info.render.calls,geometryCount:Fd.info.memory.geometries,textureCount:Fd.info.memory.textures,frameTimeMs:{p50:e[Math.floor(e.length*.5)]??null,p95:e[Math.floor(e.length*.95)]??null,samples:e.length,method:`requestAnimationFrame intervals after warmup; includes browser scheduling`},assetBootMs:ef,documentToReadyMs:Pd+ef,browser:navigator.userAgent,renderer:n?t.getParameter(n.UNMASKED_RENDERER_WEBGL):null,gpuTimeMs:null,settings:{toneMapping:`ACESFilmic`,exposure:Fd.toneMappingExposure,key:Rd.intensity,fill:zd.intensity,beacon:Bd.intensity,dynamicShadows:Fd.shadowMap.enabled,bloom:Jd===`polished`,SSAO:!1,DOF:!1},animation:Sf(),materialPolicy:`Imported original glTF materials, no forced material simplification`,backgroundGpuLoad:`uncontrolled; desktop timing is not a phone or engine ranking`}}window.addEventListener(`resize`,hf),document.addEventListener(`visibilitychange`,()=>{lf=performance.now()}),Fd.setAnimationLoop(()=>{let e=performance.now(),t=e-lf,n=Math.min(t/1e3,.1);if(lf=e,$d){if(cf&&sf.length<5e3&&sf.push(t),!document.hidden&&(Xd||nf.update(n),Zd)){Qd=(Qd+n)%12;let e=Math.floor(Qd/4),t=bf[e],r=bf[e+1];tf.root.position.lerpVectors(t,r,Qd%4/4),tf.root.position.y=tf.root.userData.groundY,tf.root.rotation.y=Math.atan2(r.x-t.x,r.z-t.z)}Fd.info.reset(),Jd===`polished`?Gd.render():Fd.render(Id,Ld)}});async function wf(){tf=await mf(`aetherion-authored-v20.glb`,`aetherion`,1.85,[-1.6,0,0]);let e=await qd.loadAsync(`./assets/3d/giftborne-authored-motion-v3.glb`);nf=new Wo(tf.gltf.scene);for(let[t,n]of Object.entries(uf)){let r=e.animations.find(e=>e.name===n);if(!r)throw Error(`Missing clip `+n);let i=r.clone();for(let e of i.tracks){e.name=e.name.replace(/^Armature\./,`GiftborneMotionRig.`);let t=X.parseTrackName(e.name);if(!X.findNode(tf.gltf.scene,t.nodeName))throw Error(`Missing motion target `+e.name)}df.set(t,i)}let t=await mf(`skyreach-residents-authored-v2.glb`,`lyra`,1.8,[1.6,0,.8],`GB_VARIANT_LYRA_STARWARDEN`),n=await mf(`vault-sentinel-authored-v4.glb`,`sentinel`,1.82,[-.6,0,4]);await mf(`skyreach-modular-architecture-authored-v1.glb`,`beacon`,5,[0,0,-4],`GB_SKYREACH_LANDMARK_TEMPLATE`);for(let e of[t,n]){let t=e.gltf.animations.find(e=>e.name.endsWith(`_Idle`));if(t){let n=new Wo(e.gltf.scene),r=n.clipAction(t);r.play(),r.time=.5,n.update(0),r.paused=!0,of.push({mixer:n,action:r})}}gf(new URLSearchParams(location.search).get(`mode`)===`polished`?`polished`:`baseline`),yf(!0),await Fd.compileAsync(Id,Ld),ef=performance.now()-Pd,$d=!0;for(let e of[`baseline`,`polished`])document.querySelector(`#`+e).onclick=()=>gf(e);document.querySelectorAll(`[data-clip]`).forEach(e=>e.onclick=()=>vf(e.dataset.clip)),document.querySelector(`#demo`).onclick=xf,document.querySelector(`#reset`).onclick=()=>yf(!0),window.bench={ready:!0,setMode:gf,play:vf,reset:yf,freeze:()=>yf(!0),startDemo:xf,inspect:Sf,metrics:Cf,beginSample:()=>{sf.length=0,cf=!0}},Md(window.bench),jd(),window.sceneBoot?.finish()}wf().catch(e=>{console.error(e),document.querySelector(`#status`).textContent=`Ошибка загрузки: `+e.message,window.sceneBoot?.fail(`Не удалось загрузить 3D-сцену. Перезагрузите страницу.`),window.bench={ready:!1,error:e.message}});